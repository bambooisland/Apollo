...
public class ApolloSong implements Comparable<ApolloSong> {
	...
	public ApolloSong(String artist, String album, String title, String track, String path) {
		this.artist = artist;
		this.album = album;
		this.title = title;
	...
	@Override
	public int compareTo(ApolloSong target) {
